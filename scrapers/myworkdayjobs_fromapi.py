...
class Scraper:
    ...
    def __init__(self):
        ...
        self.__regex_dict = {
            ...
            'GPA':
                re.compile(
                    r'(?:(?:minimum|minimum GPA|overall.*?GPA) (?:of )?)(\d\.\d{1,2})(?: degree| cumulative GPA)?',
                    re.IGNORECASE),
            'Virtual environment':
                re.compile(
            ...
            'Hybrid environment':
                re.compile(r'(hybrid environment|work at home/office|office and home|hybrid/work at home)',
                           re.IGNORECASE),
